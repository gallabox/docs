...
1. **The bot sends the message** — the customer sees it on WhatsApp
...
**Supported formats:** images up to 5 MB, and video, audio and documents up to 16 MB. For the full list of file types and link rules, see [Media and file requirements](/whatsapp/media-requirements).
...
1. **File too large** — WhatsApp has a 5 MB limit for images. Compress the image or reduce the resolution.
2. **File URL is not publicly accessible** — the link must open the file itself, without a login. Google Drive links aren't supported. Gallabox's media library hosts files correctly for WhatsApp delivery.
3. **Unsupported format** — WhatsApp accepts JPG and PNG images only. Convert other formats, including WebP, to JPG.

See [Media and file requirements](/whatsapp/media-requirements).
</Accordion>
