...
Set your agent's instructions to handle this explicitly. For example: _"If you can't find the answer in the Knowledge Base, say: 'I don't have that information yet. Let me connect you with our team who can help.' Then use @assignTo to hand off to a human agent."_ (@assignTo works on WhatsApp/Instagram agents; for Web Chat, configure a [WhatsApp handoff](/web-chat/website-analytics#handoff-to-whatsapp) instead, since Web Chat has no Inbox for a human to pick up.)
</Accordion>
</AccordionGroup>
