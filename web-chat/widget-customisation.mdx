...
1. Go to **AI Agents and Bots → \[Your Agent] → Web Widget**.
...
Copy the embed code from **AI Agents and Bots → \[Your Agent] → Web Widget → Copy Code**. Add it to your website's HTML just before the closing `</body>` tag. If you're using a CMS like WordPress, add it via your theme's custom HTML block or footer section.
</Accordion>
