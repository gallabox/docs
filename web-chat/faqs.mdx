...
Create a Chat AI Agent with **Web** as the channel (**AI Agents and Bots → Create New → Chat AI Agent**), configure the widget on the agent's **Web Widget** tab, then add the embed code to your site. Full steps: [Web Chat Setup](/web-chat/setup).
</Accordion>
...
Yes — set the colours in **AI Agents and Bots → \[Your Agent] → Web Widget**. Full options: [Web Chat Widget Customisation](/web-chat/widget-customisation).
</Accordion>
...
Enable **Contact Capture** in **AI Agents and Bots → \[Your Agent] → Web Widget** and choose when to ask — immediately, or after 1–3 replies. Turn on **Forced Capture** if visitors must provide their details before continuing. See [Widget Customisation](/web-chat/widget-customisation#contact-capture).
</Accordion>

<Accordion title="How do I set up WhatsApp handoff from Web Chat?">
Enable **Handoff Configuration** in **AI Agents and Bots → \[Your Agent] → Web Widget**, select the WhatsApp channel, and choose a display style. Details: [Website Analytics](/web-chat/website-analytics#handoff-to-whatsapp).
</Accordion>
</AccordionGroup>
