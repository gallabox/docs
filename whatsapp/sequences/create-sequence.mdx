...
| Template not appearing in the step dropdown                           | Template is not yet approved by Meta, or it's paused/disabled                                        | Go to **WhatsApp → Templates** and verify the template status is **Approved**. Pending or rejected templates cannot be added to steps.                        |
